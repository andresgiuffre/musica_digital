...
urlpatterns = [
    ...
    path('api/cursos/bloque/<int:bloque_id>/lineas-espacios/registrar/', views.bloque_lineas_espacios_registrar, name='bloque_lineas_espacios_registrar'),
    path('api/cursos/bloque/<int:bloque_id>/ligaduras-puntillo/archivo/', views.bloque_ligaduras_puntillo_archivo, name='bloque_ligaduras_puntillo_archivo'),
    path('api/cursos/bloque/<int:bloque_id>/ligaduras-puntillo/registrar/', views.bloque_ligaduras_puntillo_registrar, name='bloque_ligaduras_puntillo_registrar'),
